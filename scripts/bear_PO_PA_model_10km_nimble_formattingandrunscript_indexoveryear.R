...
PAdata <- read.csv("allNY_2016-2018_bearPAdata_pixelID_10kmgrid_final.csv")

#read in presence-only data
POdata <- read.csv("allNY_2016_2018_bearPOrecord_pixelID_10kmgrid_noweeklydups_final.csv")
...
#note using 2016 data as iSeeMammals started in 2017
#remove 2016
...
out = for (chain in 1:n.chains){
  source("./models/nimble_ppp_integrated_model_bear_10km_yearindexed_randomeffects_centrered.R")
...
save(allthestuff, "bear_ISDM_randomeffectsmonitored_chainsandstatelist.RData")